...
*	Descrição: 
*
*	Tarefa 03: Cada processo mantém localmente o vetor State[N]. Inicializa o State[N] com -1
*	(indicando estado “unknown”) para todos os demais processos e 0 para o próprio processo.
*	Nesta tarefa ao executar um teste, o processo atualiza a entrada correspondente no vetor
*	State[N]. Em cada intervalo de testes, mostre o vetor State[N].
*
*/
